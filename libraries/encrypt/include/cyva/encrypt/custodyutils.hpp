...
#ifndef SHORT_CURVE
#define _CYVA_PAIRING_PARAM_ "type a\n\
...
#define _CYVA_GENERATOR_ "[65919675513796648672789818923465948251795268192765238019657366518918945557340570440796163625394782700898920959988147581140543372885475021419922767690877, \
...
#define CYVA_SIZE_OF_NUMBER_IN_THE_FIELD 32
#else
#define _CYVA_PAIRING_PARAM_ "type a\n\
...
#define _CYVA_GENERATOR_ "[86840749517316137157891261963398293121077652946631672762188488864778675462754, \
46298439815083954540948251518245740272972067256063234341481114422918560267725]"
#endif

//Make it 16 to better fit into mpz
#define CYVA_SIZE_OF_NUMBER_IN_THE_FIELD 16

#define CYVA_MP_SIZE_OF_NUMBER_IN_THE_FIELD ( CYVA_SIZE_OF_NUMBER_IN_THE_FIELD / sizeof(long long) )
...
public:
    ...
    * @param pubKey is generated public key. There must be at least CYVA_SIZE_OF_POINT_ON_CURVE_COMPRESSED bytes allocated in the pubKey
    * @return 0 if success
    */
...
private:
    ...
    * TODO_CYVA rework to stram version
    */
   int get_sigmas(std::fstream &file, const unsigned int n, element_t *u, element_t pk, element_t **sigmas);
   /*
    * Generates u from seed seedU. The array must be initalized to at least CYVA_SIZE_OF_POINT_ON_CURVE_COMPRESSED elements
    */
