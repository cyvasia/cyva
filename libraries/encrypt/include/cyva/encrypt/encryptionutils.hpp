...
#define CYVA_EL_GAMAL_GROUP_ELEMENT_SIZE 64 //bytes
#define CYVA_EL_GAMAL_CIPHERTEXT_SIZE (2 * CYVA_EL_GAMAL_GROUP_ELEMENT_SIZE) //bytes
#define CYVA_MESSAGE_SIZE 32 //bytes
#define CYVA_HASH_SIZE 32 //bytes
#define CYVA_PROOF_OF_DELIVERY_SIZE (CYVA_EL_GAMAL_GROUP_ELEMENT_SIZE * 5 + 2 * (CYVA_HASH_SIZE +1)) //bytes
const CryptoPP::Integer CYVA_EL_GAMAL_MODULUS_512(
...
const CryptoPP::Integer CYVA_EL_GAMAL_GROUP_GENERATOR(3);


const CryptoPP::Integer CYVA_SHAMIR_ORDER("115792089237316195423570985008687907852837564279074904382605163141518161494337" );
